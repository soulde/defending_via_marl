...
class SandBox:
    def __init__(self, config: Config, map_generator, mission, states_wrapper, renderer, info_logger=Logger):
        ...
        self.reward_scale_factor = self.config['reward_scale_factor']
        ...
        self.logger = info_logger(None, self)
        self.info_buffer = {}
    ...
    def step(self, actions):
        ...
        if done or truncation:
            info.update({'_final_info': self.n_step})
    ...
    def action_space(self):
        return np.array([self.mission_.num_agents, 2])
